contract;
//852a59e20274388603ac44b2a9d4659f2380c839e254f9696d1e2d1da277d131
...
impl publicationAbi for Contract {
    ...
    #[storage(read, write)]
    fn setNewPublication(interactionTypeParam: u64, content: str[280]) {
